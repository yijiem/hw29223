...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dskzq1g295.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.bucketFilenameGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket'], ['body']);
        
        var bucketFilenameGetRequest = {
        ...
        return apiGatewayClient.makeRequest(bucketFilenameGetRequest, authType, additionalParams, config.apiKey);
    };
